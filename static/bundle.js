...
var _Chat = __webpack_require__(48);
...
*/
var aa=__webpack_require__(3),m=__webpack_require__(18),A=__webpack_require__(6),B=__webpack_require__(4),ca=__webpack_require__(19),da=__webpack_require__(20),ea=__webpack_require__(21),ha=__webpack_require__(22),ia=__webpack_require__(23),C=__webpack_require__(7);
...
var _MessageItem = __webpack_require__(74);

var _MessageItem2 = _interopRequireDefault(_MessageItem);

var _PeopleItem = __webpack_require__(75);

var _PeopleItem2 = _interopRequireDefault(_PeopleItem);

var _TypingList = __webpack_require__(76);
...
var Chat = function (_Component) {
    ...
    function Chat() {
        ...
        _this.componentDidMount = function () {
            _this.setState({ inputHeight: _this.input.clientHeight });
        };

        _this.brouserEvent = function () {
            window.addEventListener("blur", function () {
                return _this.setState({ windowIsBlur: true });
            });
            window.addEventListener("focus", function () {
                return _this.setState({ windowIsBlur: false });
            });
        };
        ...
        _this.setSocket = function () {
            ...
            _this.socket.on('user left', function (data) {
                self.userLeft(data);
            });
            ...
            _this.socket.on('reconnect', function (ctx, number) {
                console.log("reconnect: ", number);
            });

            console.log("setted socket events: ", new Date() - _this.date);
        };

        _this.userJoined = function (data) {
            console.log(data.userData.userName + ' joined');
            if (_this.state.listPeople.length) {
                _this.state.listPeople.forEach(function (item) {
                    if (item.userId === data.userData) return;
                });
                var newList = _this.state.listPeople;
                newList.unshift(data.userData);
                _this.setState({ listPeople: newList });
            } else {
                var listPeople = Object.keys(data.total).map(function (item) {
                    return _extends({ userId: item }, data.total[item]);
                });
                _this.setState({ listPeople: listPeople, isAddUser: true });
            }
            _this.input.focus();
        };

        _this.userLeft = function (data) {
            console.log(data.userData.userName + ' left');
            var listPeople = Object.keys(data.total).map(function (item) {
                return _extends({ userId: item }, data.total[item]);
            });
            _this.setState({ listPeople: listPeople });
        };
        ...
        _this.newMessage = function (data) {
            ...
            _this.notificationToBrowser(item);
        };

        _this.notificationToBrowser = function (item) {
            if (!_this.state.windowIsBlur) return;
            var options = {
                body: item.text,
                icon: item.photo
            };
            var title = 'New message from ' + item.name;
        ...
        _this.sendMessage = function () {
            var message = _this.input.innerHTML;
            if (!message) {
                return;
            }
            ...
            _this.setState({ inputHeightDiff: 0 });
            // console.log(message);
        };

        _this.onChangeInput = function () {
            // change height svg
            _this.setState({ inputHeightDiff: _this.input.clientHeight - _this.state.inputHeight });
            // scroll list message to bottom
            _this.scrollMessageToBottom();
            var self = _this;
            _this.setState({ typingDate: new Date() });
            _this.onTypingOn();
        ...
        _this.getUserData = function () {
            ...
            console.log("start get user data: ", new Date() - _this.date);

            fetch("/userData", options).then(function (data) {
                return data.json();
            }).then(function (userData) {
                console.log("finish get user data: ", new Date() - _this.date);
                // let data = userData;
        ...
        _this.launchAddUser = function () {
            if (_this.state.isAddUser) {
                _this.socket.emit('new message', "< Hi >");
                return;
            } else {
                _this.addUser();
                setTimeout(function () {
        ...
        _this.addUser = function () {
            var data = { userName: _this.state.userName, photo: _this.state.photo, link: _this.state.link };
            console.log('add user', data.userName);
            // this.socket.emit('new message', "everyone joined");
            _this.socket.emit('add user', data);
        };
        ...
        _this.date = new Date();
        console.log("constructor: ", new Date() - _this.date);

        // this.socket = io('http://localhost:3000');
        _this.socket = (0, _socket2.default)(window.location.origin, {
            reconnection: true,
    ...
    _createClass(Chat, [{
        ...
        value: function render() {
            ...
            var inputHeightDiff = this.state.inputHeightDiff;
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { className: 'username-link', href: this.state.link, target: '_blank', title: this.state.userName },
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement('div', { className: 'message-input',
                            ...
                            _react2.default.createElement(
                                'button',
                                { onClick: this.sendMessage, className: 'message-sent' },
                                'Sent'
                            ),
                            _react2.default.createElement(
                                'svg',
                                { width: 568, height: inputHeightDiff ? inputHeightDiff + 50 : 0,
                                    className: 'input-deco-left',
                                    viewBox: '0 -50 568 ' + (inputHeightDiff ? inputHeightDiff + 50 : 0) },
                                _react2.default.createElement('path', { d: 'M0,' + inputHeightDiff + ' T135,0 515,0 568,' + inputHeightDiff })
                            )
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.state.listPeople.length && this.state.listPeople.map(function (item) {
                            return _react2.default.createElement(_PeopleItem2.default, { key: item.userId, item: item });
                        }) || _react2.default.createElement(
                            'a',
...
exports.default = function (data) {
    ...
    return _react2.default.createElement(
        ...
        item.link ? _react2.default.createElement(
            "a",
            { className: "message-photo", href: item.link, target: "_blank" },
            _react2.default.createElement("img", { src: item.photo, className: "message-photo-img" }),
            _react2.default.createElement(
                "span",
        ...
        _react2.default.createElement("div", { className: "message-body", dangerouslySetInnerHTML: { __html: item.text } }),
        _react2.default.createElement(
            "div",
...
exports.default = function (data) {
    ...
    return item.link ? _react2.default.createElement(
        ...
        _react2.default.createElement("img", { src: item.photo, alt: "", className: "people-photo" }),
        item.userName
    ) : _react2.default.createElement(
        "a",
        { className: "people-item" },
